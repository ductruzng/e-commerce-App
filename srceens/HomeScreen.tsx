import { Image, ScrollView, StatusBar, StyleSheet, SafeAreaView, Text, TextInput, TouchableOpacity, View, Pressable } from 'react-native'
  ...
  return (
    <>
      <SafeAreaView style={{
        ...
        <StatusBar backgroundColor={'#FEBE10'} barStyle={'light-content'} />
        <View style={styles.headerContainer}>
          <TouchableOpacity style={styles.searchInputContainer}>
            <Ionicons name='search' size={24} color={'black'} />
            <Text
              style={{ flex: 1 }}>Search Amazon.in</Text>
          </TouchableOpacity>
          <TouchableOpacity
        ...
        <ScrollView
          ...
          <TouchableOpacity
            ...
            <Text>Deliver to Sujan - Bangalore 57405</Text>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
            {deals.map((item, index) => (
              <TouchableOpacity
                ...
                <Image
                  style={{ width: 180, height: 230, resizeMode: 'contain' }}
                  source={{ uri: item?.image }}
                />
              </TouchableOpacity>
            ))}
          </View>
          <Text style={{ height: 1, marginTop: 15, borderColor: '#D0D0D0', borderWidth: 2 }} />
            ...
            {offers.map((item, index) => (
              <TouchableOpacity
                ...
                <Image
                  ...
                  source={{ uri: item?.image }}
                />
                <View style={{ backgroundColor: '#E31837', paddingVertical: 5, width: 130, justifyContent: 'center', alignItems: 'center', borderRadius: 4, marginTop: 10 }}>
      ...
      >
        <ModalContent style={{ width: '100%', height: 400 }}>
          <View style={{ marginBottom: 8 }}>
            ...
            <Text style={{ marginTop: 5, fontSize: 16 }}>Select a delivery location to see product availabilty and delivery options</Text>
          </View>
          ...
          <View style={{ gap: 10, marginBottom: 15 }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5 }}>
              <Fontisto name='world-o' size={24} color={'#0066b2'} />
